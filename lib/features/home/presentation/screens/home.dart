      ...
      body: Container(
                 ...
                 child: TextField(
                     decoration: InputDecoration(
                      ...
                      //  contentPadding: EdgeInsets.all(10.0),
                       ...
                       suffixIcon: CustomButton(icon: Icon(Icons.search_rounded,size: 30,),onPressed: (){},)
                     ),
                   ),
               ),
             ),
       ...
       Expanded(child:   ListView.builder(
          ...
          itemBuilder: (context,index){
            ...
            return article_card(context: context,title: "Four Things Everone needs to know",authorName:"Rechard Gervain",postDate: "Jan 12 2023");
          }))
        ]),
      ),
      floatingActionButton:CustomButton(icon: Icon(Icons.add),onPressed: (){}),
    );
  }
